...
//import 'package:sample01/QRcode/themeData.dart';
import 'bubble_indication.dart';
import 'themeData.dart' as Theme;
...
class _qrBarCodeState extends State<qrBarCode> with SingleTickerProviderStateMixin{
        ...
        child: Container(
          ...
          decoration: new BoxDecoration(
            gradient: new LinearGradient(
                colors: [
                  Theme.Colours.loginGradientStart,
                  Theme.Colours.loginGradientEnd
                ],
  ...
  Widget _buildGenButton(BuildContext context) {
    return GestureDetector(
        ...
        child: Container(
          ...
          height: 50.0,
          decoration: BoxDecoration(
            color: Theme.Colours.loginGradientEnd,
            borderRadius: BorderRadius.all(Radius.circular(25.0)),
          ),
          child: Center(
            child: Icon(
